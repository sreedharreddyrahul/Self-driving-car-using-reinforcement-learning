    ...
    def score(self, goal):
        ...
        if(den == 0):
            ...
            if t > 0 and t < 1 and u < 1 and u > 0:
                ...
                if d < 20:
                    #pygame.draw.circle(self.screen, (0,255,0), pt, 5)
...
class RacingEnv:
    ...
    def render(self, action):
        ...
        if action == 4:
            pygame.draw.rect(self.screen,(225,225,225),(850, 50, 40, 40)) 
        elif action == 6:
            pygame.draw.rect(self.screen,(255,255,255),(850, 50, 40, 40))
        ...
        # score
        text_surface = self.font.render(f'VALUE: {self.car.points}', True, pygame.Color('white'))
        self.screen.blit(text_surface, dest=(0, 0))
        # speed
        text_surface = self.font.render(f'SPEED: {self.car.vel*-1}', True, pygame.Color('white'))
